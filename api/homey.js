...
// Cache for Homey API connection
...
async function getHomeyApi() {
  ...
  const AthomCloudAPI = homeyApi.AthomCloudAPI;
  ...
  // Authenticate - CORRECT METHOD NAME!
  await cloudApi.authenticateWithPassword({
